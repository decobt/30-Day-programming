...
* to be formed from the top left of a 5x5 grid to the bottom right. For this input, your program should therefore
* return the string rrdrdrdd. There will only ever be one correct path and there will always be at least
* one question mark within the input string.
*/
function CorrectPath(){
  //define test cases
  this.tests = ["r?d?drdd", "drdr??rrddd?", "dddd?uuuurrr????", "rdrdr??rddd?dr", "rrrr????"];
  this.results = ["rrdrdrdd", "drdruurrdddd", "ddddruuuurrrdddd", "rdrdruurdddldr", "rrrrdddd"];
